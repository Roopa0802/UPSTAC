...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        //Retrieve the test results which are completed by the lab tester
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        //Find the tests consultations done by the logged in Doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        // Assign the consultation/test reports to the Doctor logged in to the application
        try {
